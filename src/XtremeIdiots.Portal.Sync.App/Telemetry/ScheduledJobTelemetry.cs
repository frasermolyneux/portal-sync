...
{
    public class ScheduledJobTelemetry
    {
        ...
        public ScheduledJobTelemetry(TelemetryClient telemetryClient, string jobName, Dictionary<string, string>? additionalProperties = null)
        {
        ...
        {
            stopwatch.Stop();
            var successProperties = new Dictionary<string, string>(properties)
            {
                ["Status"] = "Success",
        ...
        {
            stopwatch.Stop();
            var failureProperties = new Dictionary<string, string>(properties)
            {
                ["Status"] = "Failed",
                ["DurationMs"] = stopwatch.ElapsedMilliseconds.ToString(),
                ["EndTime"] = DateTime.UtcNow.ToString("o"),
